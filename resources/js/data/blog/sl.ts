...
export const blogPostsSl: BlogPost[] = [
    {
        slug: 'kako-zdruziti-pdf-datoteke-na-spletu',
        lang: 'sl',
        title: 'Kako brezplačno združiti PDF datoteke na spletu',
...
<p>Za velike serije datotek orodje učinkovito obravnava na desetine dokumentov, saj se vsa obdelava izvaja lokalno na vaši napravi.</p>`,
        date: '2023-06-15',
        tool: 'merge-pdf',
        tags: ['združevanje', 'kombiniranje', 'pdf'],
    },
    {
        slug: 'stiskanje-pdf-zmanjsanje-velikosti-datoteke',
        lang: 'sl',
        title: 'Kako stisniti PDF in zmanjšati velikost datoteke',
...
<p>PDF-ji s številnimi slikami se lahko zmanjšajo za 50-80 %, medtem ko dokumenti s samim besedilom dosežejo manjše, a še vedno smiselne zmanjšave.</p>`,
        date: '2022-03-20',
        tool: 'compress-pdf',
        tags: ['stiskanje', 'zmanjšanje', 'velikost-datoteke'],
    },
    {
        slug: 'razdelitev-pdf-izvlecenje-strani',
        lang: 'sl',
        title: 'Kako razdeliti PDF in izvleči določene strani',
...
<p>Vse izvlečene datoteke je mogoče prenesti posamezno ali kot priročen ZIP arhiv.</p>`,
        date: '2021-11-08',
        tool: 'split-pdf',
        tags: ['razdelitev', 'izvlečenje', 'strani'],
    },
    {
        slug: 'sukanje-strani-pdf-popravek-usmerjenosti',
        lang: 'sl',
        title: 'Popravek usmerjenosti PDF strani: Kako zasukati strani PDF',
...
<p>Za natančnejši nadzor nad posameznimi stranmi uporabite orodje <a href="#/organize-pdf">Organiziraj PDF</a>, ki vam omogoča upravljanje strani posamezno.</p>`,
    ...
    {
        slug: 'dodajanje-vodnega-znaka-v-pdf',
        lang: 'sl',
        title: 'Kako dodati vodni znak v PDF dokumente',
...
<p>Uporabite vizualni predogled z vleci in spusti za natančno pozicioniranje vodnega znaka. Prilagodite prosojnost, da bo viden, a ne moteč — 30-50 % prosojnosti deluje dobro za večino primerov uporabe.</p>`,
        date: '2023-01-25',
        tool: 'watermark-pdf',
        tags: ['vodni-znak', 'zaščita', 'blagovna-znamka'],
    },
    {
        slug: 'pretvorba-pdf-v-jpg-slike',
        lang: 'sl',
        title: 'Pretvorite strani PDF v slike JPG',
...
<p>Vsaka stran postane ločena JPG datoteka. Prenesite jih posamezno ali kot ZIP arhiv. Za prosojno ozadje razmislite o uporabi pretvornika <a href="#/pdf-to-png">PDF v PNG</a>.</p>`,
    ...
    {
        slug: 'ustvarjanje-pdf-iz-slik',
        lang: 'sl',
        title: 'Kako ustvariti PDF iz slik (JPG, PNG, WebP)',
...
<p>Vrstni red vaših slik je pomemben — povlecite in spustite za preureditev pred pretvorbo. Vsaka slika postane ena stran v rezultirajočem PDF-ju.</p>`,
        date: '2022-07-03',
        tool: 'jpg-to-pdf',
        tags: ['pretvorba', 'slike', 'ustvarjanje'],
    },
    {
        slug: 'zaščita-pdf-dokumentov-z-geslom',
        lang: 'sl',
        title: 'Kako zaščititi PDF dokumente z geslom',
...
<p>Morate pozneje odstraniti zaščito? Uporabite orodje <a href="#/unlock-pdf">Odkleni PDF</a> s pravilnim geslom.</p>`,
    ...
    {
        slug: 'odstranitev-zaščite-z-geslom-pdf',
        lang: 'sl',
        title: 'Kako odstraniti zaščito z geslom iz PDF',
...
<li>Rezultirajoča datoteka ne bo imela nobenega gesla ali omejitev dovoljenj</li>
        ...
        date: '2024-02-14',
        tool: 'unlock-pdf',
        tags: ['odklepanje', 'geslo', 'odstranitev'],
    },
    {
        slug: 'organiziranje-strani-pdf-preureditev-brisanje',
        lang: 'sl',
        title: 'Organizirajte strani PDF: preuredite, izbrišite in podvojite',
...
<p>To orodje odlično deluje v kombinaciji z <a href="#/merge-pdf">Združi PDF</a> — najprej združite več datotek, nato organizirajte združene strani.</p>`,
    ...
    {
        slug: 'obrezovanje-pdf-prilagoditev-robov',
        lang: 'sl',
        title: 'Kako obrezati strani PDF in prilagoditi robove',
...
<p>Obrezovanje se enotno uporabi na vseh straneh, kar dobro deluje za dokumente z doslednimi postavitvami.</p>`,
        date: '2024-06-01',
        tool: 'crop-pdf',
        tags: ['obrezovanje', 'robovi', 'prilagoditev'],
    },
    {
        slug: 'redigiranje-obcutljivih-informacij-pdf',
        lang: 'sl',
        title: 'Kako redigirati občutljive informacije v PDF dokumentih',
...
<h2>Pomembno</h2>
<p>Vedno preverite redigirani dokument pred deljenjem. Ker se vsa obdelava izvaja lokalno, vaši občutljivi podatki nikoli ne zapustijo vaše naprave — kar naredi to orodje idealno za delovne postopke, ki cenijo zasebnost.</p>`,
        date: '2024-11-20',
        tool: 'redact-pdf',
        tags: ['redigiranje', 'zasebnost', 'občutljivo'],
    },
    {
        slug: 'dodajanje-besedila-oblik-v-pdf',
        lang: 'sl',
        title: 'Urejanje PDF: dodajte besedilo, oblike in risbe',
...
<p>Za dodajanje podpisa posebej je orodje <a href="#/sign-pdf">Podpiši PDF</a> bolj priročno.</p>`,
    ...
    {
        slug: 'podpisovanje-pdf-dokumentov-na-spletu',
        lang: 'sl',
        title: 'Kako podpisati PDF dokumente na spletu',
...
<h2>Pravna opomba</h2>
<p>To orodje doda vizualno prekrivanje podpisa. Za pravno zavezujoče digitalne podpise s kriptografskimi certifikati (PAdES/P7M) je potrebna kvalificirana podpisna storitev.</p>`,
        date: '2025-03-01',
        tool: 'sign-pdf',
        tags: ['podpis', 'dokument', 'overitev'],
    },
    {
        slug: 'izvlecenje-slik-iz-pdf',
        lang: 'sl',
        title: 'Kako izvleči vse slike iz PDF datoteke',
...
<p>Prenesite vsako sliko posamezno ali vse naenkrat z možnostjo prenosa ZIP. Opomba: to orodje izvleče vdelane slike, ne posnetkov zaslona strani. Za celostranke slike uporabite <a href="#/pdf-to-png">PDF v PNG</a>.</p>`,
    ...
    {
        slug: 'pretvorba-pdf-v-sivine',
        lang: 'sl',
        title: 'Pretvorite barvni PDF v sivine (črno-belo)',
        excerpt: 'Pretvorite barvne PDF-je v sivine za tiskanje, zmanjšanje stroškov črnila ali ustvarjanje profesionalnega monokromatskega videza.',
        body: `<p>Pretvorba v sivine je uporabna za varčevanje s črnilom pri tiskanju, izpolnjevanje zahtev za oddajo ali doseganje enotnega videza dokumenta.</p>
...
<p>Za nadaljnje zmanjšanje velikosti datoteke po pretvorbi v sivine, rezultat obdelajte z orodjem <a href="#/compress-pdf">Stisni PDF</a>.</p>`,
    ...
    {
        slug: 'dodajanje-stevilk-strani-v-pdf',
        lang: 'sl',
        title: 'Kako dodati številke strani v PDF dokumente',
...
<p>Za več prilagoditev orodje <a href="#/header-footer">Glava in noga</a> ponuja dodatne možnosti, vključno s prilagojenim besedilom.</p>`,
    ...
    {
        slug: 'spreminjanje-velikosti-strani-pdf',
        lang: 'sl',
        title: 'Kako spremeniti velikost strani PDF v A4, Letter ali druge oblike',
...
<p>Vsebina se sorazmerno prilagodi novi velikosti strani ob ohranjanju izvirnega razmerja stranic.</p>`,
        date: '2024-04-08',
        tool: 'resize-pdf',
        tags: ['spreminjanje-velikosti', 'velikost-strani', 'a4'],
    },
    {
        slug: 'sploščitev-polj-obrazcev-pdf',
        lang: 'sl',
        title: 'Kako sploščiti polja obrazcev in označbe v PDF',
        excerpt: 'Pretvorite interaktivna polja obrazcev in označbe v statično vsebino. Bistveno pred deljenjem ali arhiviranjem izpolnjenih obrazcev.',
        body: `<p>Sploščitev PDF-ja pretvori interaktivne elemente — polja obrazcev, potrditvena polja, spustne menije, označbe — v statično vsebino strani, ki je ni mogoče spremeniti.</p>
...
<p><a href="#/flatten-pdf">Orodje za sploščitev PDF</a> obdela dokument z enim klikom. Rezultirajoča datoteka izgleda enako, vendar so vsi interaktivni elementi zdaj del vsebine strani.</p>`,
    ...
    {
        slug: 'izvlecenje-besedila-iz-pdf',
        lang: 'sl',
        title: 'Kako izvleči besedilo iz PDF dokumentov',
...
<p>Za ohranjanje vizualne postavitve strani razmislite o pretvorbi v slike z uporabo <a href="#/pdf-to-jpg">PDF v JPG</a> ali <a href="#/pdf-to-png">PDF v PNG</a>.</p>`,
    ...
    {
        slug: 'pretvorba-pdf-v-png-prosojno',
        lang: 'sl',
        title: 'Pretvorite PDF v slike PNG s prosojnim ozadjem',
        excerpt: 'Pretvorite strani PDF v visokokakovostne slike PNG. Podpora za prosojna ozadja, idealno za predstavitve in spletno grafiko.',
        body: `<p>Oblika zapisa PNG ponuja brezizgubno stiskanje in podporo za prosojnost, kar jo naredi idealno za diagrame, grafikone in grafike, ki morajo biti vdelane v predstavitve ali spletne strani.</p>
<h2>PNG proti JPG</h2>
<ul>
...
<p>Če je velikost datoteke pomembnejša od kakovosti, razmislite o pretvorniku <a href="#/pdf-to-jpg">PDF v JPG</a>.</p>`,
    ...
    {
        slug: 'dodajanje-glav-nog-pdf',
        lang: 'sl',
        title: 'Dodajte prilagojene glave in noge v PDF dokumente',
...
<p>Za dodajanje samo številk strani brez dodatnega besedila uporabite preprostejše orodje <a href="#/page-numbers">Številke strani</a>.</p>`,
    ...
    {
        slug: 'najboljsa-brezplacna-pdf-orodja-za-studente',
        lang: 'sl',
        title: 'Najboljša brezplačna PDF orodja za študente in akademike',
        excerpt: 'Bistvena PDF orodja, ki jih potrebuje vsak študent: združite predavanja, stisnite naloge, izvlecite besedilo in več — vse brezplačno in zasebno.',
...
<p>Vsa orodja obdelujejo datoteke lokalno v vašem brskalniku. Vaši raziskovalni članki in akademsko delo nikoli ne zapustijo vaše naprave — pomembno pri delu z neobjavljenimi raziskavami.</p>`,
        date: '2025-09-15',
        tool: 'merge-pdf',
        tags: ['študentje', 'akademsko', 'brezplačno'],
    },
    {
        slug: 'najboljse-prakse-varnosti-pdf',
        lang: 'sl',
        title: 'Najboljše prakse varnosti PDF: zaščitite svoje dokumente',
        excerpt: 'Naučite se, kako zavarovati občutljive PDF-je z gesli, redigiranjem in sploščitvijo. Popoln vodnik po varnosti dokumentov.',
...
<li>Pozaba na redigiranje metapodatkov in skritih plasti</li>
        ...
        date: '2025-06-20',
        tool: 'protect-pdf',
        tags: ['varnost', 'zasebnost', 'najboljše-prakse'],
    },
    {
        slug: 'paketna-obdelava-vec-pdf-jev',
        lang: 'sl',
        title: 'Kako paketno obdelati več PDF datotek naenkrat',
        excerpt: 'Uporabite isto operacijo na več PDF-jih hkrati. Stisnite, zasukajte, pretvorite ali preoblikujte na desetine datotek v enem zamahu.',
        body: `<p>Obdelava PDF datotek po eno je dolgočasna, ko jih imate na desetine. Paketna obdelava vam omogoča uporabo iste operacije na več datotekah hkrati.</p>
...
<p>Vsa obdelava poteka lokalno na vaši napravi, zato hitrost zavisi od vašega računalnika. Večina operacij se zaključi v sekundah tudi za velike serije.</p>`,
        date: '2026-01-10',
        tool: 'compress-pdf',
        tags: ['paketno', 'več-datotek', 'produktivnost'],
    },
    {
        slug: 'optimizacija-pdf-za-splet',
        lang: 'sl',
        title: 'Kako optimizirati PDF-je za spletno objavo',
        excerpt: 'Naredite vaše PDF-je prijazne spletu z zmanjšanjem velikosti datoteke, pretvorbo v slike ali prilagoditvijo dimenzij strani za ogled na zaslonu.',
...
<li>Nad 10 MB — pred objavo je treba stisniti</li>
        ...
        date: '2025-11-05',
        tool: 'compress-pdf',
        tags: ['optimizacija', 'splet', 'zmogljivost'],
    },
    {
        slug: 'brezplacna-pdf-orodja-brez-nalaganja',
        lang: 'sl',
        title: 'Brezplačna PDF orodja, ki nikoli ne naložijo vaših datotek',
        excerpt: 'Zakaj je obdelava PDF v brskalniku najvarnejša izbira. Vaše datoteke ostanejo na vaši napravi — brez strežnikov, brez oblaka, brez tveganja.',
        body: `<p>Večina spletnih PDF orodij naloži vaše datoteke na oddaljene strežnike za obdelavo. To ustvarja tveganja za zasebnost in varnost, zlasti za zaupne dokumente.</p>
...
<p>Vseh 22 orodij deluje brez povezave: od <a href="#/merge-pdf">združevanja</a> in <a href="#/compress-pdf">stiskanja</a> do <a href="#/sign-pdf">podpisovanja</a> in <a href="#/redact-pdf">redigiranja</a>. Vsaka operacija se izvaja lokalno, kar vam daje popoln nadzor nad vašimi podatki.</p>`,
    ...
    {
        slug: 'priprava-pdf-za-tiskanje',
        lang: 'sl',
        title: 'Kako pripraviti PDF-je za profesionalno tiskanje',
        excerpt: 'Pripravite vaše PDF-je za tisk: spremenite velikost na standardne velikosti papirja, pretvorite v sivine, obrežite robove in sploščite obrazce.',
...
<li>Barvni dokumenti, ki izgledajo nepričakovano pri tiskanju v sivinah</li>
        ...
        date: '2025-04-18',
        tool: 'resize-pdf',
        tags: ['tiskanje', 'priprava', 'profesionalno'],
    },
    {
        slug: 'vodnik-po-pdf-obrazcih',
        lang: 'sl',
        title: 'Vodnik po PDF obrazcih: izpolnite, sploščite in delite',
        excerpt: 'Kako delati z interaktivnimi PDF obrazci — izpolnite jih, zaklenite podatke s sploščitvijo in varno delite izpolnjene obrazce.',
...
<p>Za dodatno varnost <a href="#/protect-pdf">zaščitite z geslom</a> sploščeni PDF pred deljenjem.</p>`,
    ...
    {
        slug: 'primerjava-slikovnih-oblik-pdf',
        lang: 'sl',
        title: 'PDF v JPG ali PNG: katero slikovno obliko izbrati?',
        excerpt: 'Razumite razlike med JPG in PNG pri pretvarjanju PDF-jev v slike. Izberite pravo obliko za vaše potrebe.',
        body: `<p>Pri pretvarjanju strani PDF v slike je izbira med JPG in PNG odvisna od vašega primera uporabe: velikosti datoteke, kakovosti in potreb po prosojnosti.</p>
...
<p>Potrebujete majhne datoteke za splet ali e-pošto? Izberite JPG. Potrebujete popolno kakovost ali prosojna ozadja? Izberite PNG.</p>`,
        date: '2025-07-25',
        tool: 'pdf-to-jpg',
        tags: ['jpg', 'png', 'primerjava'],
    },
    {
        slug: 'upravljanje-pdf-dokumentov-v-pisarni',
        lang: 'sl',
        title: 'Upravljanje PDF dokumentov v pisarni: praktičen vodnik',
        excerpt: 'Poenostavite potek dela s PDF-ji v pisarni: združite poročila, organizirajte strani, dodajte številke strani in zaščitite zaupne datoteke.',
...
<p>Začnite z združevanjem povezanih datotek, nato organizirajte strani, dodajte številke strani in na koncu stisnite rezultat za distribucijo.</p>`,
        date: '2025-10-30',
        tool: 'merge-pdf',
        tags: ['pisarna', 'potek-dela', 'produktivnost'],
    },
    {
        slug: 'popoln-vodnik-zdruzevanje-razdelitev-pdf',
        lang: 'sl',
        title: 'Popoln vodnik po združevanju in razdelitvi PDF datotek',
        excerpt: 'Obvladajte umetnost kombiniranja in deljenja PDF-jev. Naučite se, kdaj združiti, kdaj razdeliti in kako doseči najboljše rezultate.',
        body: `<p>Združevanje in razdelitev sta dve najosnovnejši operaciji s PDF-ji. Razumevanje, kdaj in kako uporabiti vsako, je bistveno za učinkovito upravljanje dokumentov.</p>
<h2>Kdaj združiti</h2>
<ul>
...
<p>Potrebujete strani iz več dokumentov? Najprej razdelite vsako izvorno datoteko za izvlečenje strani, ki jih potrebujete, nato združite izvlečene strani v vaš končni dokument.</p>`,
        date: '2026-03-01',
        tool: 'merge-pdf',
        tags: ['združevanje', 'razdelitev', 'vodnik'],
    },
    {
        slug: 'pretvorba-markdown-v-pdf-vodnik',
        lang: 'sl',
        title: 'Kako pretvoriti Markdown v PDF: popoln vodnik',
        excerpt: 'Pretvorite datoteke Markdown v lepo oblikovane PDF dokumente neposredno v brskalniku. Brez strežnikov, brez namestitev.',
        body: `<p>Markdown je priljubljena oblika za pisanje dokumentacije, zapiskov in tehnične vsebine. Ko pa gre za deljenje z netehničnimi kolegi ali tiskanje, je PDF standard.</p>
...
<p>Pretvornik obravnava vso standardno sintakso Markdown, vključno s krepkim tiskom, ležečim tiskom, povezavami, slikami, citati, urejenimi in neurejenimi seznami, kodnimi bloki z barvnim označevanjem sintakse ter tabelami. Vaša vsebina se obdela v celoti v brskalniku za popolno zasebnost.</p>`,
        ...
        tags: ['markdown', 'pretvorba', 'dokumentacija'],
    },
    {
        slug: 'digitalni-podpisi-proti-elektronskim-podpisom-pdf',
        lang: 'sl',
        title: 'Digitalni in elektronski podpisi na PDF-jih: kaj morate vedeti',
        excerpt: 'Razumite razlike med digitalnimi in elektronskimi podpisi ter se naučite, kako jih dodati v PDF dokumente.',
...
<p>Za večino vsakdanjih dokumentov, kot so interne odobritve, obrazci soglasij in neformalni dogovori, so elektronski podpisi zadostni in pravno priznani v večini pristojnosti. Za pogodbe visoke vrednosti ali regulatorne dokumente digitalni podpisi zagotavljajo močnejšo pravno veljavnost.</p>`,
        date: '2026-02-18',
        tool: 'sign-pdf',
        tags: ['podpis', 'digitalni-podpis', 'elektronski-podpis'],
    },
    {
        slug: 'kako-narediti-pdf-dostopen-vodnik',
        lang: 'sl',
        title: 'Kako narediti PDF dokumente dostopne',
        excerpt: 'Spoznajte najboljše prakse za ustvarjanje dostopnih PDF dokumentov, ki jih lahko berejo vsi, vključno z uporabniki bralnikov zaslona.',
        body: `<p>Dostopni PDF-ji zagotavljajo, da vsakdo, vključno z ljudmi z invalidnostmi, lahko dostopa do vaše vsebine in jo razume. Dostopnost ni le dobra praksa — pogosto je tudi zakonska zahteva.</p>
...
<p>Vedno preizkusite svoje PDF-je z bralnikom zaslona, preden jih razpošljete. Preprosti preizkusi vključujejo preverjanje, ali je besedilo mogoče izbrati in kopirati ter ali je vrstni red branja smiseln.</p>`,
        date: '2026-01-22',
        tool: 'edit-pdf',
        tags: ['dostopnost', 'vkljucevanje', 'bralnik-zaslona'],
    },
    {
        slug: 'nasveti-za-avtomatizacijo-pdf-poteka-dela',
        lang: 'sl',
        title: 'Avtomatizacija poteka dela s PDF-ji: nasveti za maksimalno produktivnost',
        excerpt: 'Poenostavite potek dela z dokumenti s praktičnimi nasveti za avtomatizacijo ponavljajočih se opravil s PDF-ji z brskalniškimi orodji.',
        body: `<p>Delo s PDF-ji je vsakodnevno opravilo za mnoge strokovnjake. Od stiskanja prilog e-pošte do združevanja poročil lahko ta ponavljajoča se opravila pojedo dragocen čas.</p>
...
<p>Nastali EPUB vključuje kazalo vsebine z enim vnosom na izvorno stran, kar olajša navigacijo po pretvorjenem dokumentu.</p>`,
    ...
    },
    {
        ...
        lang: 'sl',
        title: 'Kako ustvariti PDF-knjižico za obojestransko tiskanje',
        excerpt: 'Prerazporedite strani PDF za tiskanje knjižice s šivanjem na hrbet. Natisnite obojestransko, prepognite na pol in spnite za profesionalno knjižico.',
        body: `<p>Ustvarjanje knjižice iz PDF pomeni prerazporeditev strani, tako da se ob obojestranskemtiskanju in prepognitvi na pol prikažejo v pravilnem bralnem vrstnem redu.</p>
...
<p>Za druge potrebe razporeditve strani preizkusite orodje <a href="#/nup-pdf">N-Up PDF</a> za več strani na list ali <a href="#/reverse-pages">Obrni strani</a> za obrnitev vrstnega reda strani.</p>`,
        date: '2026-03-10',
        tool: 'booklet-pdf',
        tags: ['knjizica', 'tiskanje', 'dupleks', 'prepogibanje'],
    },
];
