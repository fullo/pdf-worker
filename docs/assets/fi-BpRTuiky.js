const a=[{slug:"pdf-tiedostojen-yhdistaminen-verkossa",lang:"fi",title:"PDF-tiedostojen yhdistaminen verkossa ilmaiseksi",excerpt:"Opi yhdistamaan useita PDF-asiakirjoja yhdeksi tiedostoksi ilman ohjelmiston asentamista. Nopeaa, turvallista ja taysin ilmaista.",body:`<p>PDF-tiedostojen yhdistaminen on yksi yleisimmista tehtavista asiakirjojen kanssa tyoskenneltaessa. Tarvitsetpa sitten yhdistaa raportteja, sopimuksia tai esityksia, luotettava tyokalu tekee kaiken eron.</p>
...
<p>Kaikki kasittely tapahtuu paikallisesti selaimessasi. Tiedostojasi ei koskaan ladeta millekaan palvelimelle, joten voit turvallisesti muokata luottamuksellisten asiakirjojen metatietoja ilman yksityisyyshuolia.</p>`,date:"2026-03-07",tool:"edit-metadata",tags:["metadata","properties","edit","privacy"]},{slug:"pdf-muuntaminen-webp-moderni-formaatti",lang:"fi",title:"PDF:n muuntaminen WebP-muotoon: moderni kuvaformaatti",excerpt:"Muunna PDF-sivut WebP-kuviksi ylivertaisen pakkauksen ja laadun saavuttamiseksi. Ihanteellinen verkkokäyttöön, nopeampaan lataukseen ja pienempiin tiedostokokoihin kuin JPG tai PNG.",body:`<p>WebP on Googlen kehittämä moderni kuvaformaatti, joka tarjoaa ylivertaisen häviöttömän ja häviöllisen pakkauksen verkkokuville. PDF-tiedostojen muuntaminen WebP-muotoon antaa pienempiä tiedostoja vastaavalla laadulla.</p>
...
<p>Valitse WebP verkkojulkaisuun, jossa tiedostokoko on tärkeä. Käytä <a href="#/pdf-to-jpg">JPG:tä</a> maksimaalisen yhteensopivuuden saavuttamiseksi vanhemman ohjelmiston kanssa. Käytä <a href="#/pdf-to-png">PNG:tä</a>, kun tarvitset läpinäkyviä taustoja tai häviötöntä laatua.</p>`,date:"2026-03-10",tool:"pdf-to-webp",tags:["webp","muuntaminen","moderni","verkko"]},{slug:"nup-pdf-useita-sivuja-yhdelle-arkille",lang:"fi",title:"Useiden PDF-sivujen tulostaminen yhdelle arkille (N-Up)",excerpt:"Yhdistä 2, 4 tai 9 PDF-sivua yhdelle arkille paperin säästämiseksi, monisteiden luomiseksi tai tiiviiden asiakirjakatsausten tuottamiseksi.",body:`<p>N-Up-tulostus järjestää useita sivuja yhdelle arkille. Tämä sopii erinomaisesti monisteiden luomiseen, paperin säästämiseen tai pitkän asiakirjan tiiviin yleiskatsauksen saamiseen.</p>
...
<p>Parhaan luettavuuden saavuttamiseksi käytä 2-Up-asettelua tekstipainotteisille asiakirjoille ja 4-Up- tai 9-Up-asettelua diaesityksille.</p>`,date:"2026-03-10",tool:"nup-pdf",tags:["nup","tulostus","moniste","paperi"]},{slug:"tyhjan-sivun-lisaaminen-pdf-asiakirjaan",lang:"fi",title:"Tyhjän sivun lisääminen PDF-asiakirjaan",excerpt:"Lisää tyhjä sivu PDF-tiedoston alkuun tai loppuun. Hyödyllinen kansisivuille, välisivuille tai kaksipuolisen tulostuksen valmisteluun.",body:`<p>Tyhjän sivun lisääminen PDF-tiedostoon on yksinkertainen mutta usein tarvittava toimenpide. Tarvitsetpa paikkamerkin, välisivun tai kaksipuolisen tulostuksen valmistelun, tämä työkalu hoitaa sen sekunneissa.</p>
...
<p>Monimutkaisempaan sivujen hallintaan käytä <a href="#/organize-pdf">PDF-järjestelytyökalua</a>, joka mahdollistaa sivujen uudelleenjärjestämisen ja kopioinnin visuaalisesti.</p>`,date:"2026-03-10",tool:"add-blank-page",tags:["tyhjä","sivu","lisäys","kaksipuolinen"]},{slug:"tyhjien-sivujen-poistaminen-pdf-tiedostosta",lang:"fi",title:"Tyhjien sivujen automaattinen tunnistaminen ja poistaminen PDF-tiedostosta",excerpt:"Siisti PDF-tiedostosi tunnistamalla ja poistamalla tyhjät sivut automaattisesti. Täydellinen skannatuille asiakirjoille, joissa on ei-toivottuja tyhjiä arkkeja.",body:`<p>Skannatut asiakirjat sisältävät usein tyhjiä sivuja yksipuolisten alkuperäisten kaksipuolisesta skannauksesta. Niiden manuaalinen poistaminen sivu sivulta on työlästä.</p>
<h2>Kuinka se toimii</h2>
...
<p>Työkalu on riittävän älykäs erottamaan aidosti tyhjät sivut ja sivut, joissa on vähäistä sisältöä. Sivut, joissa on pienikin määrä tekstiä tai grafiikkaa, säilytetään. Jos kaikki sivut ovat tyhjiä, työkalu ilmoittaa sinulle sen sijaan, että loisi tyhjän asiakirjan.</p>`,date:"2026-03-10",tool:"remove-blank-pages",tags:["tyhjä","poistaminen","siistiminen","skannaus"]},{slug:"ocr-skannattu-pdf-haettavaksi",lang:"fi",title:"OCR: tee skannatuista PDF-tiedostoista haettavia ja valittavia",excerpt:"Käytä optista tekstintunnistusta lisätäksesi tekstikerroksen skannattuihin PDF-asiakirjoihin. Tee kuvapohjaista PDF-tiedostoista haettavia, valittavia ja saavutettavia.",body:`<p>Skannatut asiakirjat ovat käytännössä kuvia PDF:n sisällä — niistä ei voi hakea, valita tai kopioida tekstiä. OCR (optinen tekstintunnistus) ratkaisee tämän tunnistamalla tekstin kuvista ja lisäämällä näkymättömän haettavan kerroksen.</p>
...
<p>OCR-käsittelyn jälkeen voit käyttää <a href="#/pdf-to-text">PDF tekstiksi -työkalua</a> tunnistetun tekstin poimimiseen.</p>`,date:"2026-03-10",tool:"ocr-pdf",tags:["ocr","skannaus","haettava","tekstintunnistus"]},{slug:"kahden-pdf-asiakirjan-visuaalinen-vertailu",lang:"fi",title:"Kahden PDF-asiakirjan visuaalinen vertailu",excerpt:"Havaitse erot kahden PDF-asiakirjan version välillä visuaalisella rinnakkaisvertailulla ja automaattisella erojen korostuksella.",body:`<p>Asiakirjojen muutoksia, sopimusmuutoksia tai suunnittelumuutoksia tarkasteltaessa sinun on nopeasti tunnistettava, mikä on muuttunut PDF:n kahden version välillä.</p>
<h2>Kuinka se toimii</h2>
...
<p>Lataa molemmat versiot, ja työkalu tuottaa ladattavan vertailu-PDF:n, jonka voit tarkistaa omaan tahtiisi.</p>`,date:"2026-03-10",tool:"compare-pdf",tags:["vertailu","erot","tarkistus","versiot"]},{slug:"pelkan-tekstin-muuntaminen-pdf-muotoon",lang:"fi",title:"Pelkän tekstin muuntaminen PDF-muotoon: nopeasti ja helposti",excerpt:"Muunna tekstitiedostot tai liitetty teksti hyvin muotoilluiksi PDF-asiakirjoiksi. Automaattinen rivinvaihto, sivutus ja ammattimainen asettelu.",body:`<p>Joskus tarvitset vain pelkän tekstin muuntamista siistiksi, jaettavaksi PDF-tiedostoksi — ei hienoa muotoilua, vain luettavaa tekstiä ammattimaisessa asiakirja-asettelussa.</p>
<h2>Kuinka se toimii</h2>
...
<p>Rikkaampaan muotoiluun otsikoilla, listoilla ja linkeillä käytä sen sijaan <a href="#/markdown-to-pdf">Markdown PDF:ksi</a> -työkalua.</p>`,date:"2026-03-10",tool:"text-to-pdf",tags:["teksti","muuntaminen","luominen","pelkkä-teksti"]},{slug:"pdf-sivujarjestyksen-kaantaminen",lang:"fi",title:"PDF-sivujärjestyksen kääntäminen",excerpt:"Käännä PDF-asiakirjasi sivujärjestys niin, että viimeinen sivu tulee ensimmäiseksi. Täydellinen käänteisten skannausten tai tulostusjonojen korjaamiseen.",body:`<p>Joskus asiakirjat päätyvät väärään järjestykseen — käänteiset skannaukset, käännetyt tulostusjonot tai yksinkertaisesti tarve lukea takaa eteenpäin. Kääntäminen korjaa tämän yhdellä napsautuksella.</p>
...
<p>Valikoivampaan sivujen uudelleenjärjestelyyn käytä <a href="#/organize-pdf">PDF-järjestelytyökalua</a>, jossa voit vetää ja pudottaa yksittäisiä sivuja.</p>`,date:"2026-03-10",tool:"reverse-pages",tags:["kääntäminen","järjestys","sivut","kääntö"]},{slug:"pdf-varien-kaantaminen-tumma-tila",lang:"fi",title:"PDF-värien kääntäminen tummaa tilaa varten",excerpt:"Muunna valkotaustaiset PDF-tiedostot tummaan tilaan käännetyillä väreillä. Vähennä silmien rasitusta, säästä mustetta tai luo taiteellisia efektejä.",body:`<p>Värien kääntäminen muuttaa valkotaustaisen asiakirjan tummataustaiseksi (ja päinvastoin). Tämä on hyödyllistä mukavaan tumman tilan lukemiseen tai visuaalisten efektien luomiseen.</p>
...
<p>Väriasiakirjojen muuntamiseen harmaasävyisiksi käytä sen sijaan <a href="#/grayscale-pdf">Harmaasävy-PDF</a> -työkalua.</p>`,date:"2026-03-10",tool:"invert-colors",tags:["kääntäminen","tumma-tila","värit","saavutettavuus"]},{slug:"vaurioituneiden-pdf-tiedostojen-korjaaminen",lang:"fi",title:"Vaurioituneiden tai vahingoittuneiden PDF-tiedostojen korjaaminen",excerpt:"Korjaa rikkinäiset PDF-tiedostot, jotka eivät avaudu tai näyttävät virheitä. Korjaustyökalu jäsentää ja rakentaa asiakirjan rakenteen uudelleen sisällön palauttamiseksi.",body:`<p>PDF-tiedostot voivat vaurioitua keskeneräisten latausten, tallennusvirheiden tai ohjelmistovirheiden vuoksi. Kun PDF ei avaudu tai näkyy väärin, korjausyritys voi usein palauttaa sisällön.</p>
...
<p>Huomaa: vakavasti vaurioituneet tiedostot, joissa ydindata on tuhoutunut, eivät välttämättä ole palautettavissa. Useimpien yleisten vaurioongelmien kohdalla korjaustyökalu kuitenkin palauttaa asiakirjan onnistuneesti.</p>`,date:"2026-03-10",tool:"repair-pdf",tags:["korjaaminen","korjaus","vaurioitunut","palautus"]},{slug:"pdf-muuntaminen-epub-sahkokirjaksi",lang:"fi",title:"PDF:n muuntaminen EPUB-muotoon sähkökirjalukijoille",excerpt:"Muunna PDF-asiakirjat EPUB-muotoon mukavaan lukemiseen Kindlellä, Kobolla ja muilla sähkökirjalukijoilla. Teksti mukautuu minkä tahansa näytön kokoon.",body:`<p>PDF-tiedostot on suunniteltu kiinteään asetteluun, mikä tekee niistä vaikeita lukea pienillä näytöillä. EPUB on sähkökirjojen vakiomuoto, jossa teksti mukautuu mihin tahansa näyttökokoon.</p>
